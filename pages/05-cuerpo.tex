...
\chapter{Diseño y desarrollo de la plataforma}
    ...
    \section{Arquitectura}
        ...
        % Como se muestra en la figura \ref{fig:arquitectura}, la idea principal es que el usuario interactúe con el sitio web a través del front-end, que se comunica con el back-end para realizar las acciones que el usuario solicite; mientras que el back-end se comunica con la base de datos para almacenar y recuperar datos, y con los contenedores Docker para gestionar los laboratorios de pruebas.
