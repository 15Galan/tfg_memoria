...
\chapter{Catálogo de conceptos}
    ...
    \section{Fuerza bruta}
        ...
        Este apartado es especialmente corto dada la naturaleza básica del concepto, ya que se consideró que no era necesario profundizar en él por su conexión con otros más relevantes, como por ejemplo el hash-cracking \ref{sec:hash-cracking}.
    ...
    \section{Ransomware}
        ...
        \subsection{Motivación}
            ...
            Se ha considero importante usar una parte de este trabajo de fin de grado para concienciar a los usuarios sobre la amenaza real que supone el ransomware, ya que es una de las amenazas más comunes en la actualidad y puede causar mucho daño en un sistema.
...
\chapter{Resultados}
    ...
    \section{Cumplimiento de los requisitos}
        ...
        Esta sección abarcará el cumplimiento de los requisitos funcionales y no funcionales del proyecto, así como el cumplimiento de los objetivos planteados en la sección Objetivos \ref{sec:objetivos}.

        Para ello, se han llevado a cabo pruebas manuales.
