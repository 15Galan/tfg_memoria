...
\chapter{Diseño y desarrollo de la plataforma}
    ...
    \section{Modelado de actividades y transiciones}
        ...
        \subsection{Tratamiento de \textit{sandboxes}}
            ...
            El proceso de creación de una \textit{sandbox} iniciará pulsando un botón, preferiblemente ubicado al final de un contenido instructivo descrito anteriormente en \textit{Consulta de la documentación} \ref{sec:consulta-documentacion}, debiendo verificar que es posible crear dicha \textit{sandbox}.
...
\chapter{Problemas encontrados}
    ...
    \section{Limitación de los contenedores Docker}
