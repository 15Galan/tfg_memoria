\chapter{Introducción}
    ...
    \section{Estructura global del proyecto}
        ...
        \subsection{Página web}
            ...
            \subsubsection{Alojamiento}
                ...
                Respecto al alojamiento, se han considerado varias opciones, tales como GitHub Pages \cite{github-pages}, Vercel \cite{vercel}, OVHcloud \cite{ovhcloud} o Heroku \cite{heroku}.
                ...
                En cuanto a la base de datos, se ha decidido utilizar MySQL por ser una opción muy utilizada, fácil de configurar y ser nativamente compatible con WordPress. Se usará la tabla \texttt{wp\_usermeta} para almacenar la información de los laboratorios activos.
            
        \subsection{Investigación}
        
            Consistirá en recopilar y seleccionar diferentes conceptos y técnicas relacionados con el pentesting. Este apartado se verá mejor reflejado en la sección \ref{cap:catalogo}.
        ...
        \subsection{Virtualización}
            ...
            Elegir Docker como plataforma de virtualización es una buena opción, porque ofrece una gestión de recursos eficiente y una generación de laboratorios sencilla a través de imágenes y contenedores; por otro lado, Vagrant Cloud \cite{vagrant-cloud} es una buena opción para crear máquinas virtuales, ya que ofrece una amplia gama de imágenes preconfiguradas.
            
            Por otro lado, también se consideraron plataformas que brindan servicios de almacenamiento y distribución de imágenes, como Docker Hub \cite{docker-hub} para imágenes de contenedores de Docker y Vagrant Cloud para máquinas virtuales preconfiguradas. Estas dos plataformas brindan enlaces de descargas con las que un usuario puede acceder a recursos previamente construidos por su autor.
    ...
    \section{Tecnologías empleadas}
        ...
        Esta sección recoge de forma directa las tecnologías y herramientas que se usaron para llevar a cabo el proyecto. Algunas de ellas fueron una elección clara, mientras que otras pasaron por un proceso de análisis, recogido en la sección \ref{sec:analisis-tecnologias}.
        ...
        \subsection{WordPress}
            ...
            WordPress se ha usado para crear la página web de la plataforma; además, se ha empleado un tema hijo a partir del tema Divi \cite{divi}, uno de los temas más populares de WordPress y que además, incluye su propio editor de páginas (Divi Builder).
...
\chapter{Investigación previa}
    ...
    \section{Estado del arte}
        ...
        \subsection{Hack The Box}
            ...
            \begin{figure}[h]
                ...
                \caption{Web de Hack The Box \cite{hackthebox}}
                \label{fig:HTB-web}
            \end{figure}
        ...
        \subsubsection{HTB Academy}
            ...
            \begin{figure}[h]
                ...
                \caption{Web de HTB Academy \cite{hackthebox-academy}}
        ...
        \subsection{TryHackMe}
            ...
            \begin{figure}[h]
                ...
                \caption{Web de TryHackMe \cite{tryhackme}}
                \label{fig:THM-web}
            \end{figure}
        ...
        \subsection{VulnHub}
            ...
            \begin{figure}[h]
                ...
                \caption{Web de VulnHub \cite{vulnhub}}
        ...
        \subsection{OverTheWire}
            ...
            \begin{figure}[h]
                ...
                \caption{Web de OverTheWire \cite{overthewire}}
            ...
            Al contrario de lo que sucede con otras plataformas, entre ellas Hack The Box y TryHackMe mencionadas anteriormente, esta plataforma es completamente gratuita y todo su contenido está construido por y para los usuarios.
    ...
    \section{Proceso creativo}
        ...
        Ya se realizó una investigación previa sobre las diferentes plataformas de aprendizaje de ciberseguridad existentes -descritas en la sección anterior (\ref{sec:estado-arte})- con el objetivo de analizar sus características y funcionalidades.
        ...
        \subsection{Docker para los laboratorios}
            ...
            \begin{figure}[htbp]
                ...
                \includegraphics{images/Diagramas/Articulo.png}
    ...
    CMD ["python", "app.py"]
                ...
                \begin{figure}[!htbp]
                    ...
                    \includegraphics[scale=0.125]{images/Diagramas/Contenedor B.png}
        ...
        \subsection{Página web}
            ...
            \subsubsection{WordPress y Astro}
                ...
                \paragraph{Personalización}
                    ...
                    Teniendo en cuenta lo mencionado en el punto anterior acerca de la falta de conocimientos previos, se hubiera empleado una gran cantidad de tiempo no solo en aprender a elaborar un buen \textit{front-end} desde cero, sino que el objetivo principal de este trabajo de fin de grado no se centra tanto en la página web, sino en el sistema completo, pudiendo considerar la mejora del \textit{front-end} como una posible futura línea de trabajo (sección \ref{sec:futuras-lineas-trabajo}).
        ...
        \subsection{Alojamiento}
            ...
            \subsubsection{Linode}
                ...
                \paragraph{Linode Kubernetes Engine (LKE)}
                    ...
                    Este servicio se encarga de la configuración, el aprovisionamiento y la administración de los nodos de un clúster, lo que permite a los usuarios centrarse en el desarrollo de sus aplicaciones en lugar de en la gestión de la infraestructura subyacente.
            ...
            \subsubsection{Google Cloud Platform (GCP)}
                ...
                \paragraph{Google Kubernetes Engine (GKE)}
                    ...
                    Este servicio permite ejecutar aplicaciones en contenedores de forma sencilla y rápida, sin necesidad de gestionar la infraestructura subyacente. Se planteó como una opción para la gestión de los contenedores Docker que hacen de laboratorios del proyecto.
...
\chapter{Diseño y desarrollo de la plataforma}
    ...
    \section{Arquitectura}
        ...
        Los componentes de la plataforma podrían dividirse en 4 partes fundamentales: el \textit{front-end}, el \textit{back-end}, la base de datos y los contenedores Docker (laboratorios). Todos estos están desplegados en un servidor que utiliza LAMP.

        \subsection{\textit{Front-end}: WordPress}

            El \textit{front-end} es la parte de la plataforma que interactúa con el usuario; en este caso, se ha desarrollado una aplicación web que permite al usuario acceder a la plataforma y realizar las acciones que se describen en la sección \ref{sec:casos-uso}.
            
            Se ha usado un tema hijo generado a partir del tema Divi, definido como \textit{divi-child}; dicho tema actua como eje central tanto para el diseño como para la funcionalidad de la plataforma web, como se describe en el siguiente apartado.

            \begin{figure}[!htbp]
                \centering

                \includegraphics[scale=0.20]{images/Capturas/divi-builder.png}

                \caption{Estructura de la plataforma web}
                \label{fig:divi-child}
            \end{figure}

        \subsection{\textit{Back-end}: \texttt{functions.php}}
        
            El \textit{back-end} se encarga de gestionar las peticiones del usuario y de comunicarse con la base de datos y los contenedores Docker. Se ha usado el fichero \texttt{functions.php} del tema \textit{divi-child} para implementar el \textit{back-end} de la plataforma, ya que este fichero permite extender las funcionalidades de un sitio web de WordPress de forma sencilla.
        ...
        \subsection{\textit{Back-end}: tareas de Cron}
    ...
    * * * * * /bin/bash /var/www/html/scripts/stop-1h-container.sh > /var/www/html/scripts/stop-1h-container.log 2>&1
        ...
        \subsection{Base de datos: MySQL}
            ...
            WordPress gestiona todo su contenido a través de una base de datos: configuración, publicaciones, usuarios registrados... aprovechando ese funcionamiento, se ha usado la base de datos de WordPress para almacenar los datos de los laboratorios de pruebas, y concretamente, se ha usado la tabla \texttt{wp\_usermeta}.

            \begin{figure}[!htbp]
                \centering

                \includegraphics[scale=0.4]{images/Capturas/wp_usermeta.png}

                \caption{Estructura de la tabla \texttt{wp\_usermeta}}
                \label{fig:wp_usermeta}
            \end{figure}

            \newpage

            El fichero \texttt{functions.php} conecta con la base de datos cada vez que el usuario quiere interactuar con un laboratorio desde la plataforma, y usa la tabla \texttt{wp\_usermeta} para almacenar los datos de los laboratorios en uso (el usuario que lo está usando, el puerto de conexión, etc.).

            \begin{figure}[!htbp]
                \centering

                \includegraphics[scale=0.35]{images/Capturas/wp_usermeta-data.png}

                \caption{Datos de la tabla \texttt{wp\_usermeta}}
                \label{fig:wp_usermeta-data}
            \end{figure}

            \begin{itemize}
                \item \textbf{user\_id}: identificador del usuario que ha realizado la acción; en este caso, el usuario que está usando un laboratorio de pruebas.
                \item \textbf{meta\_key}: identificador del tipo de valor que se está almacenando; en este caso, información de un laboratorio activo.
                \item \textbf{meta\_value}: información que se almacena; en este caso, los datos de un laboratorio activo (ID del contenedor, puerto...) en formato JSON.
            \end{itemize}

            A continuación se muestra el contenido del laboratorio activo en la figura \ref{fig:wp_usermeta-data}:
            \\
            ...
            \begin{lstlisting}[style=bash_style, basicstyle=\ttfamily\scriptsize]
    {
        ...
        \subsection{Contenedores Docker: laboratorios de pruebas}
            ...
            Los laboratorios son construidos a partir de imágenes contruidas con ficheros \texttt{Dockerfile} locales, por lo que pueden crearse nuevos laboratorios de pruebas de forma rápida y sencilla para extender la plataforma. Esto se explica más detalladamente en los apéndices del documento.
    ...
    \section{Modelado de actividades y transiciones}
        ...
        \subsection{Consulta de documentación}
        ...
        \subsection{Tratamiento de laboratorios}
            ...
            \begin{figure}[h]
                ...
                \begin{subfigure}{0.45\textwidth}
                    ...
                    \caption{Inicio de un laboratorio}
                ...
                \begin{subfigure}{0.45\textwidth}
                    ...
                    \caption{Detención de un laboratorio}
            ...
            El proceso de inicio de un laboratorio iniciará pulsando un botón, preferiblemente ubicado al final de un contenido instructivo descrito anteriormente en la sección \ref{sec:consulta-documentacion}, debiendo verificar que es posible crear dicho laboratorio.
            ...
            \begin{enumerate}
                \item El usuario solicita iniciar un laboratorio para probar el concepto tratado en la página informativa pulsando el botón de inicio, ejecutando algunas de las funcionalidades de la plataforma definidas en \texttt{functions.php}.
                ...
                \item Se cambia el estado de la sección \textit{Laboratorio} de la página: se añade la IP de la plataforma (en este caso, \texttt{localhost}) y el puerto del sistema asociado al contenedor, y se cambia el botón de la sección para que ahora detenga el laboratorio.
            \end{enumerate}
            ...
            \begin{figure}
                ...
                \caption{Detención de un laboratorio desde el sitio web}
            ...
            \begin{enumerate}
                ...
                \item Se hace una llamada al sistema para detener el contenedor Docker usando la ID obtenida en el paso anterior, y como todos los contenedores se han creado con la opción \texttt{--rm}, al detenerse son eliminados.
                ...
                \item Se cambia el estado de la sección \textit{Laboratorio} de la página: se eliminan la IP y el puerto asociados y se cambia el botón de la sección para que ahora inicie de nuevo el laboratorio.
            \end{enumerate}
            ...
            \begin{enumerate}
                \item La tarea de cron del sistema ejecuta un script de Bash (apéndice \ref{sec:scripts}) para detener los contenedores Docker que se encuentren activos y cuyo tiempo de vida exceda a 1 hora. Esta tarea se ejecuta cada minuto.
...
\chapter{Catálogo de conceptos}
    ...
    \section{Esteganografía}
        ...
        Este laboratorio presenta una definición de esteganografía y muestra de herramientas comunes, como \texttt{steghide} y \texttt{exiftool}.
    ...
    \section{Fuerza bruta}
        ...
        La fuerza bruta es una técnica en la que se intenta adivinar una contraseña o credencial de acceso probando diferentes combinaciones hasta encontrar la correcta. Generalmente, usando un diccionario de contraseñas como \texttt{rockyou.txt}.
        ...
        \subsection{Laboratorio}
            ...
            Este entorno presenta un sistema Linux vulnerable, ya que la contraseña del usuario \texttt{root} es una contraseña común y pertenece al diccionario \texttt{rockyou.txt}.


    \section{Hash-cracking}
        \label{sec:hash-cracking}

        El \textit{hash-cracking} es una técnica de ataque que se utiliza para obtener la contraseña original a partir de un hash.

        Este concepto se presensta como descripción de la técnica de \textit{hash-cracking}, abarcando el uso de herramientas para descifrar información.
    ...
    \section{Escalada de privilegios}
        ...
        \subsection{Laboratorio}
            ...
            Además, haciendo un estudio del formato de los hashes almacenados, es posible llegar a la conclusión de que las contraseñas están usando MD5 crypt, por lo que es posible descifrarlas usando una herramienta de \textit{hash-cracking}.
    ...
    \section{Bypass}
        ...
        Este concepto se presensta como una descripción del término de bypass, a través de la vulnerabilidad CVE-2017-8386 \cite{cve-2017-8386}, que permite a un atacante remoto omitir la autenticación en un servidor Git.
...
\chapter{Resultados}
    ...
    \section{Cumplimiento de los requisitos}
        ...
        Para ello se ha usado Gherkin \cite{gherkin}, un DSL (\textit{Domain-Specific Language}) que permite definir requisitos funcionales en un lenguaje natural, y que además, permite definir escenarios de prueba para comprobar el cumplimiento de dichos requisitos.
    ...
    \section{Conclusiones}
        ...
        Si bien no ha sido necesario un uso avanzado de Docker para este proyecto, sí he investigado y aprendido acerca de todas sus otras funcionalidades, como los volúmenes, las redes y los ficheros \texttt{dockercompose.yml}.
    ...
    \section{Futuras líneas de trabajo}
        ...
        \subsection{Traslado del proyecto a un servicio de alojamiento}
            ...
            Todo el proyecto está alojado en un servidor local, por lo que el siguiente paso natural sería trasladar la plataforma a un servicio de alojamiento, como por ejemplo alguno de los mencionados en la sección \ref{sec:alojamiento}, especialmente Google Compute Engine al considerarse el más compatible con la naturaleza y estructura del proyecto.
