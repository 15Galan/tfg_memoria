...
\chapter{Resultados}
    ...
    \section{Cumplimiento de los requisitos}
        ...
        Para ello, se ha usado el lenguaje Gherkin \ref{gherkin}, que permite definir requisitos funcionales en un lenguaje natural, y que además, permite definir escenarios de prueba para comprobar el cumplimiento de dichos requisitos.
